...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Coalcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"updrv.go.ro", "86.120.103.206"},
    {"82.77.63.49", "86.120.103.200"},
    {"86.120.103.1", "vps-fb0c92aa.vps.ovh.ca"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Coalcoin is probably already running."), addrBind.ToString().c_str());
        else
